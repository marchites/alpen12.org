              ...
              <ul class="navbar-nav">
                  ...
                  <li class="nav-item dropdown">
                      <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button"
                          data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <img class="wd-30 ht-30 rounded-circle" src="{{ asset('assets/images/others/faces/face1.jpeg') }}" alt="profile">
                      </a>
                      <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                          <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                              <div class="mb-3">
                                  <img class="wd-80 ht-80 rounded-circle" src="{{ asset('assets/images/others/faces/face1.jpeg') }}" alt="">
                              </div>
                              <div class="text-center">
                                  <p class="tx-16 fw-bolder">Admin Alpen12</p>
                                  <p class="tx-12 text-muted">admin@alpen12.org</p>
                              </div>
                          </div>
                          <ul class="list-unstyled p-1">
                              ...
                              <li class="dropdown-item py-2">
                                  <form method="POST" action="{{ route('logout') }}">
                                      @csrf
                                      <a href="javascript:;" class="text-body ms-0" onclick="this.closest('form').submit()">
